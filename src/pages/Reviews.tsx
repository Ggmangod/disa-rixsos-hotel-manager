...
const reviews = [
  {
    ...
    rating: 5,
    date: "2024-02-15",
    content: "Превосходный отель! Персонал очень внимательный, номера чистые и уютные. Обязательно вернусь снова!",
    likes: 12,
  },
  {
    id: 2,
    ...
    rating: 4,
    date: "2024-02-10",
    content: "Отличное расположение, прекрасный вид из окна. Завтраки разнообразные и вкусные.",
    likes: 8,
  },
  {
    id: 3,
    ...
    rating: 5,
    date: "2024-02-05",
    content: "Потрясающий сервис! Особенно понравился спа-центр и ресторан. Рекомендую всем!",
    likes: 15,
  },
];
