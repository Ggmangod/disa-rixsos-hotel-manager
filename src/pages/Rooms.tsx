...
const rooms = [
  {
    ...
    capacity: "2-3 гостя",
    amenities: ["Король-размер кровать", "Спа-ванная", "Мини-бар", "Вид на море"],
      ...
      <div className="hotel-container">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Откройте для себя непревзойденный комфорт и элегантность в наших тщательно оформленных номерах
          </p>
        </div>
